...
config :spectator_mode,
  ecto_repos: [SpectatorMode.Repo],
...
config :spectator_mode, SpectatorModeWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SpectatorModeWeb.ErrorHTML, json: SpectatorModeWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: SpectatorMode.PubSub,
  live_view: [signing_salt: "BCcJx/wl"]
